...
# for view that handles creating or updating the objects of any content model
from django.forms.models import modelform_factory
from django.apps import apps
from .models import Course, Module, Content
#django-braces is a third-party module that contains a collection of generic mixins for Django
...
'''
Class that allow you to create and update different models contents
'''
